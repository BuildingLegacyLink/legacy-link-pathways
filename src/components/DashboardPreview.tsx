              ...
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-gray-900">{formatCurrency(75200)}</p>
              ...
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold text-gray-900">+{formatCurrency(620)}</p>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm text-gray-600">XP Score</p>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-semibold">Secure Vault</h4>
                </div>
                <p className="text-gray-600 mb-3">Keep your important documents safe and organized</p>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-semibold">Smart Insights</h4>
                </div>
                <p className="text-gray-600 mb-3">AI-powered recommendations for your financial journey</p>
