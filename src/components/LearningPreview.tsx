    ...
    return (
        <div>
            <main>
                ...
                <section className="bg-gray-50 dark:bg-[#08090a] relative z-10 py-16">
                    <div className="m-auto max-w-5xl px-6">
                        <h2 className="text-center text-lg font-medium text-gray-900 dark:text-white">Building financial literacy for the next generation.</h2>
